...
class EmpresaAdmin(admin.ModelAdmin):
    ...
    def descarga_empresas_csv(self,request,queryset):
        empresas = [['NombreCompleto','nombreEmpresa','Cargo','TipodeIndustria','tamanodeEmpresa','Telefono','Correo','reto1','reto2','Dimension11','Dimension12','Dimension21','Dimension22','Dimension31','Dimension32','Dimension33','Dimension34','Dimension35','Dimension36','NivelIngresos','CostoDirectoComoPorcentaje','CostoDirecto','valorInventario']]
        for empresa in queryset:
            empresas.append([empresa.nombreCompleto,empresa.nombreEmpresa,empresa.Cargo,empresa.TipodeIndustria,empresa.tamanodeEmpresa,empresa.Telefono,empresa.Correo,empresa.reto1,empresa.reto2,empresa.Dimension11,empresa.Dimension12,empresa.Dimension21,empresa.Dimension22,empresa.Dimension31,empresa.Dimension32,empresa.Dimension33,empresa.Dimension34,empresa.Dimension35,empresa.Dimension36,empresa.NivelIngresos,empresa.CostoDirectoComoPorcentaje,empresa.CostoDirecto,empresa.valorInventario])
